(() => {
  ...
  function openPreview(sourceImage) {
    ...
    backdropStyle.textContent = `
      dialog[data-codex-generated-image-preview][open]{position:fixed;inset:0;margin:0;padding:0;border:0;width:100vw;height:100dvh;max-width:none;max-height:none;transform:none;background:transparent;color:#f5f5f5;box-sizing:border-box}
      dialog[data-codex-generated-image-preview]::backdrop{background:rgba(0,0,0,.92)}
      [data-codex-image-viewer]{position:relative;display:flex;flex-direction:column;align-items:center;width:100%;height:100%;padding:64px 24px 24px;box-sizing:border-box}
      [data-codex-image-top-controls]{position:absolute;top:16px;right:20px;z-index:2;display:flex;gap:8px}
      [data-codex-generated-image-preview-viewport]{display:flex;flex:1;min-height:0;width:100%;overflow:auto}
      [data-codex-generated-image-preview-viewport] img{display:block;margin:auto;flex:none;max-width:none;object-fit:contain}
      [data-codex-image-bottom-controls]{display:flex;flex:none;flex-direction:column;align-items:center;gap:12px;margin-top:16px;max-width:100%;color:#f5f5f5}
      [data-codex-generated-image-preview-title]{max-width:100%;padding:8px 16px;border-radius:8px;background:#242424;color:#f5f5f5;text-align:center;overflow-wrap:anywhere}
      [data-codex-image-zoom-controls]{display:flex;align-items:center;gap:4px;padding:4px;border-radius:24px;background:#242424;color:#f5f5f5}
      [data-codex-image-zoom-controls]>div{display:flex;justify-content:center;min-width:64px;color:#f5f5f5}
      dialog[data-codex-generated-image-preview] :is(button,a){display:flex;align-items:center;justify-content:center;flex:none;width:40px;height:40px;min-width:40px;padding:0;border:1px solid #666;border-radius:50%;background:#242424;color:#f5f5f5;cursor:pointer}
      dialog[data-codex-generated-image-preview] :is(button,a):hover{background:#424242}
      dialog[data-codex-generated-image-preview] :is(button,a):focus-visible{outline:2px solid #fff;outline-offset:3px}
      dialog[data-codex-generated-image-preview] button:disabled{opacity:.45;cursor:default}
      dialog[data-codex-generated-image-preview] svg{display:block;width:20px;height:20px;color:inherit}
    `;
    const viewer = document.createElement("div");
    viewer.setAttribute("data-codex-image-viewer", "true");
    ...
    topControls.setAttribute("data-codex-image-top-controls", "true");
    ...
    bottomControls.setAttribute("data-codex-image-bottom-controls", "true");
    ...
    zoomControls.setAttribute("data-codex-image-zoom-controls", "true");
  ...
  function renderImages(images, targets) {
    ...
    document.querySelectorAll("[data-codex-generated-image-id]").forEach((element) => {
      if (!ids.has(element.getAttribute("data-codex-generated-image-id"))) element.parentElement?.remove();
    });
    images.forEach((image) => {
      ...
      const nativeImage = Array.from(document.querySelectorAll("img:not([data-codex-generated-image-id])"))
        .find((element) => element.getAttribute("src")?.includes(image.id));
      if (nativeImage) {
