...
fn imports_supported_image_into_managed_theme_directory() {
    ...
    #[cfg(target_os = "macos")]
    {
        ...
        assert_eq!(&imported_bytes[..3], b"\xFF\xD8\xFF");
    }
    #[cfg(not(target_os = "macos"))]
    {
        ...
        assert_eq!(imported_bytes, image);
    }
...
fn rejects_invalid_image_during_macos_preparation() {
    ...
    std::fs::write(&source, b"not a PNG image").unwrap();
