...
const BUNDLED_IMAGEGEN_SKILL: &str = include_str!("../skill/SKILL.md");
const BUNDLED_IMAGEGEN_MATERIALIZER: &str =
    include_str!("../skill/scripts/materialize_latest.py");
const BUNDLED_RESPONSES_IMAGEGEN: &str =
    include_str!("../skill/scripts/responses_image_gen.py");
const BUNDLED_RESPONSES_TRANSPORT: &str =
    include_str!("../skill/scripts/responses_transport.py");

const BUNDLED_IMAGEGEN_FILES: &[(&str, &[u8])] = &[
    ("SKILL.md", BUNDLED_IMAGEGEN_SKILL.as_bytes()),
    (
        "LICENSE.txt",
        include_bytes!("../skill/LICENSE.txt"),
    ),
    (
        "agents/openai.yaml",
        include_bytes!("../skill/agents/openai.yaml"),
    ),
    (
        "assets/imagegen-small.svg",
        include_bytes!("../skill/assets/imagegen-small.svg"),
    ),
    (
        "assets/imagegen.png",
        include_bytes!("../skill/assets/imagegen.png"),
    ),
    (
        "references/cli.md",
        include_bytes!("../skill/references/cli.md"),
    ),
    (
        "references/codex-network.md",
        include_bytes!("../skill/references/codex-network.md"),
    ),
    (
        "references/image-api.md",
        include_bytes!("../skill/references/image-api.md"),
    ),
    (
        "references/prompting.md",
        include_bytes!("../skill/references/prompting.md"),
    ),
    (
        "references/sample-prompts.md",
        include_bytes!("../skill/references/sample-prompts.md"),
    ),
    (
        "scripts/image_gen.py",
        include_bytes!("../skill/scripts/image_gen.py"),
    ),
    (
    ...
    (
        ...
        include_bytes!("../skill/scripts/remove_chroma_key.py"),
    ),
    (
